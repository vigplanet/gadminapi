...
class SetLang {
	public function handle($request, Closure $next)
	{
        ...
        $restrictedUrls = array(
            ...
            'seller.update_status', 'seller.assign_delivery_boy', 'seller.mail_settings.save','seller.delete_seller_account', 'delivery_boy.update_status', 'delivery_boy.mail_settings.save','delivery_boy.delete_delivery_boy_account','database_backup_download.download_db_backup','products.bulk_update','store_settings.save_login_setting', 'time_slots.saveTimeSlotsSettings','countries.save','countries.update','countries.delete','store_settings.save_store_basic_setting','store_settings.save_address_setting','store_settings.save_other_setting','store_settings.save_app_setting','store_settings.save_delivery_boy_setting','store_settings.save_frontend_home_setting','store_settings.save_smtp_mail_setting','store_settings.save_third_party_api_setting','store_settings.save_seller_setting','store_settings.save_refer_earn_setting','store_settings.save_additional_charges','store_settings.save_third_party_api_setting','store_settings.test_mail','store_settings.save_cart_setting','orders.update_self_pickup_status'
        );
