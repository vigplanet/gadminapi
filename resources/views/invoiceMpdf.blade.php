                ...
                <tr>
                    ...
                    <td width="33.3">
                        <div class="text-center">
                            ...
                            @else
                            <span style="font-weight: bold;"> Customer Details </span>
                            @endif
                            <address>
                        ...
                        <table class="product-table">
                            <tbody>
                                <tr>
                                    ...
                                    <th align="right">{{ $order->remaining_total }}</th>
                                </tr>
                                @if($order->order_type == 'doorstep')
                                <tr>
                                ...
                                @if(!empty($order->additional_charges) && is_array($order->additional_charges) && count($order->additional_charges) > 0)
                                    @foreach($order->additional_charges as $charge)
                                        <tr>
                                            <td align="left">{{ $charge['title'] ?? 'Additional Charge' }} ({{ $currency }})</td>
                                            <th align="right">{{ floatval($charge['amount'] ?? 0) }}</th>
                                        </tr>
                                    @endforeach
                                @endif
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <th align="right" style="padding: 8px; background-color: #37a279; color: white;">{{ '= ' . $order->remaining_final }}</th>
                                </tr>
                            </tbody>
                        </table>
                    </td>
