        ...
        <div class="page-content">
            <section class="row">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <apexchart :options="options" :series="series" width="100%" height="350" ref="apexBarChart"></apexchart>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-3 mb-3">
                    <h5 class="w-100">Order Out Lines</h5>
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3" v-for="status in record.status_order_count" :key="status.status">
                        <div class="card h-100">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <h6 class="text-muted font-semibold mb-1">{{ status.status }}</h6>
