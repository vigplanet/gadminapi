                    ...
                    <div class="card-body">
                        ...
                        <b-table
                            ...
                            <template #cell(actions)="row">
                                <button class="btn btn-sm btn-primary" @click="edit_record = row.item" v-b-tooltip.hover :title="__('edit')" v-if="$can('faq_update')"><i class="fa fa-pencil-alt"></i> {{ __('edit') }} |
                                    {{ __('answer') }}</button>
                                <button class="btn btn-sm btn-danger" @click="deleteSocialMedia(row.index,row.item.id)" v-b-tooltip.hover :title="__('delete')" v-if="$can('faq_delete')"><i class="fa fa-trash"></i>
                                    {{ __('delete') }}</button>
                            </template>
                        </b-table>
                        <b-row>
