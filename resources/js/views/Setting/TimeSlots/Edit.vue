         ...
         <div class="row">
            ...
            <div class="form-group">
               ...
               <div class="col-md-9 text-left mt-1">
                  <input type="checkbox" id="is_free_delivery" v-model="is_free_delivery" class="form-check-input" :value="1">
                  <label for="is_free_delivery" class="form-check-label ml-2">{{ __('enable_free_delivery') }}</label>
               </div>
            </div>
