        ...
        <form ref="my-form" @submit.prevent="saveRecord">
            <div class="row">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" v-model="meta_keyword"
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" v-model="schema_markup" :placeholder="__('enter_schema_markup')"
                        rows="4"></textarea>
                </div>

                <div class="form-group col-md-12">
                    <label>{{ __('meta_description') }}</label>
                    <textarea class="form-control" v-model="meta_description"
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="og_image" accept="image/*" v-on:change="handleFileUpload" ref="file_image"
                        class="file-input">
    ...
    data() {
        return {
            ...
            pages: [
                ...
                { id: 11, name: __('blog_listing_page') }
            ]
        };
    },
