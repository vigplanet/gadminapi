                        ...
                        <div class="card-body">
                            ...
                            <b-row class="mb-2">
                                ...
                                <template v-if="$roleSeller == login_user.role.name">
                                    ...
                                    <input type="hidden" :value="seller = login_user.seller.id">
                                </template>
                                <template v-else>
                                    <b-col md="3">
                                ...
                                <b-col md="2" class="text-center">
                                    ...
                                    <div class="btn-group btn_tool" role="group" aria-label="Basic example">
                                        ...
                                        <b-dropdown dropleft menu-class="w-100 border dropdownOverflow"
                                            v-b-tooltip.hover title="Columns">
                                    ...
                                    <b-sidebar id="sidebar-right" title="Sidebar" backdrop right shadow>
                                        <div class="px-3 py-2">
                                            ...
                                            <b-img src="https://picsum.photos/500/500/?image=54" fluid
                                                thumbnail></b-img>
                                        </div>
                                    </b-sidebar>
                                </b-col>
                            ...
                            <div class="table-responsive">
                                <b-table :items="products" :fields="visibleFields" :filter="filter"
                                    ...
                                    <template #cell(stock)="row">
                                        ...
                                        <span
                                            v-if="row.item.is_unlimited_stock === 1 || row.item.is_unlimited_stock === '1'">Unlimited</span>
                                        ...
                                        <div>
                                            ...
                                            <template v-if="$roleSeller == login_user.role.name">
                                                <router-link
                                                    ...
                                                    class="btn btn-primary btn-sm" v-b-tooltip.hover
                                                    :title="__('view')">
                                                    <i class="fa fa-eye"></i>
                                                </router-link>
                                                <router-link
