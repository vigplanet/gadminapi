                                ...
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                            <h5 class="text-muted font-semibold small">{{ __('orders') }}</h5>
                                            <h3 class="font-extrabold mb-0 h5 h4-md h3-lg">{{ record.order_count }}</h3>
                                        </div>
                                    </div>
                                </div>
                            </router-link>
                        ...
                        <div class="card">
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h5 class="text-muted font-semibold small">Balance</h5>
                                        <h3 class="font-extrabold mb-0 h5 h4-md h3-lg">{{ $currency+" "+record.balance }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
